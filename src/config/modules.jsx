...
export const modules = [
  {
    name: "Dashboard",
    key: "dashboard",
    items: [{ title: "Dashboard", url: "/dashboard", icon: LayoutDashboard, module: null }],
  },
  {
    name: "Management",
    key: "management",
    items: [
      ...
      { title: "Permissions", url: "/permissions", icon: ShieldCheck, module: "Roles" },
      { title: "Keeto Users", url: "/users", icon: KeetoIcon, module: "Users" },
      { title: "Policy", url: "/policy", icon: FileText, module: "policy" },
      { title: "Reasons", url: "/reasons", icon: HelpCircle, module: "Reasons" },
  ...
  },
  {
    ...
    key: "location",
    items: [
      { title: "Countries", url: "/countries", icon: Globe, module: "Countries" },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "SubCategories", url: "/sub-categories", icon: Library, module: "Subcategories" },
      { title: "Restaurants", url: "/restaurants", icon: Utensils, module: "Restaurants" },
  ...
  },
  {
    ...
    key: "business",
    items: [
      { title: "Business Plans", url: "/business-plans", icon: Briefcase, module: "BusninessPlan" },
      {
      ...
      { title: "Payment Methods", url: "/payment-methods", icon: Wallet, module: "RestaurantWallets" },
      { title: "MyKeeto Report", url: "/mykeeto", icon: KeetoIcon, module: "reports" },
    ],
  },
  {
    name: "Marketing",
    key: "marketing",
    items: [
      { title: "Discounts", url: "/discounts", icon: BadgePercent, module: "Discounts" },
      { title: "Coupons", url: "/coupons", icon: TicketPercent, module: "Coupons" },
