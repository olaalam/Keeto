    ...
    <div className="space-y-6">
      ...
      {variationFields.map((field, index) => {
        ...
        return (
          <div
            key={field.id}
            className="p-4 border rounded-xl space-y-4 bg-gray-50/50 relative"
          >
            <Button
              type="button"
              variant="ghost"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pr-8">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="e.g. Type de croûte"
                />
              </div>
            </div>
  ...
  return (
    <div className="space-y-3">
      ...
      {optionFields.map((optField, optIndex) => (
        <div
          key={optField.id}
          className="grid grid-cols-1 md:grid-cols-4 gap-2 items-end bg-white p-2 border rounded-lg shadow-sm"
        >
          <div>
            <Label className="text-xs">Option (EN)</Label>
            <Input
              {...register(
                `variations.${nestIndex}.options.${optIndex}.optionName`,
                { required: true },
              )}
          ...
          <div>
            ...
            <Input
              {...register(
                `variations.${nestIndex}.options.${optIndex}.optionNameAr`,
                { required: true },
              )}
          ...
          <div>
            ...
            <Input
              ...
              step="0.01"
              {...register(
                `variations.${nestIndex}.options.${optIndex}.additionalPrice`,
                { required: true },
              )}
              className="h-8 text-xs"
            />
          ...
          <div className="flex items-center justify-between pb-1">
            <div className="w-full pl-1">
              ...
              <Input
                {...register(
                  `variations.${nestIndex}.options.${optIndex}.nameFr`,
                  { required: true },
                )}
                className="h-8 text-xs"
              />
    ...
    >
      {(methods) => {
        ...
        const availableSubCategories =
          selectOptions?.allSubCategories?.filter(
        ...
        const fieldsByTab = {
          ...
          details: ["restaurantid", "categoryid"],
          pricing: ["price"],
          // نفس منطق الـ nested field array — أي خطأ داخل variations بيظهر تحت هذا المفتاح
